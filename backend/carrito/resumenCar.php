...
?>
<div class="row mb-3 d-flex justify-content-between align-items-center responsive-carrito " id="articuloRes<?php echo $id?>">
...
<div class="d-flex justify-content-between mb-5">
  ...
  data-mdb-ripple-color="dark" onclick="comprar()">Compra</button>
