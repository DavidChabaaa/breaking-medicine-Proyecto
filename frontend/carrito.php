...
<body id="body">
    ...
    <script>
        ...
        //     }
        //     //variable.open("POST", "../backend/carrito/compraRealizada.php");
            
        //     if (retiro == 1) {
        //         var retiroV = "retiro";
        //         if (efectivo == 1){
        //         var efectivoV = "efectivo";
        //         //variable.send("retiro-efec= &retiro="+retiroV+"&efectivo="+efectivoV);
        //         }
        //         else if (tarjeta == 1) {
        //         let formData = new FormData(document.getElementById("tarjeta-form"));
        //         formData.append("retiro", retiroV);
        //         formData.append("efectivo", efectivoV);
        //         formData.append("retiro-tar", "");
        //         //variable.send(formData);
        //         }
                
        //     }else if (domicilio == 1) {
        //         console.log("dom");
        //         var formDataDom = new FormData(document.getElementById("direccion-form"));
        //         if (efectivo == 1) {
        //             formData.append("efectivo", efectivoV);
        //             formData.append("envio-efec", "");
        //             //variable.send(formData);
        //         }else if (tarjeta == 1) {
        //             console.log("tarjeta");
        //             let formData = new FormData(document.getElementById("tarjeta-form"));
        //             console.log(formData.get("number"));
        //             formDataDom.append("envio-tar", "");
