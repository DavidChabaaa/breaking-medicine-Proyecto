  ...
  <div class="container">
    ...
    <div class="row">
              ...
              <div class="form-group row">
                ...
                <div class="col-sm-12 col-md-8">
                  <div class="field-group select">
                    <select class="form-control" onchange="Orden(this.value) ">
                    <option id="ordenReciente">Recientes</option>
                    <option id="ordenMenor" value="menor">Menor precio</option>
                    <option id="ordenMayor" value="mayor">Mayor precio</option>
                    </select>
                  </div>
                </div>
              </div>
      ...
      <div class="col-lg-9 col-md-8">
        ...
        <div class="row mb-md-5 mb-4 mx-n2">
          ...
          <div id="paginacion" class="div-paginacion"></div>
        </div>
      </div>
    ...
    <script>
      function cambiarPagina(pag) {
        ...
        paginacion.innerHTML += "<div><a onclick=\"cambiarPagina('1')\">&lt</a></div>";
        //if(cantPaginas>11) paginacion.innerHTML += "<div><a>...</a></div>";
        for (let i = 1; i <= cantPaginas; i++) {
          paginacion.innerHTML += "<div "+(params.get("pag")==i ?"class='pag-sel'":"")+" ><a onclick=\"cambiarPagina('"+i+"')\" >"+i+"</a></div>";
        }
        //if(cantPaginas>11) paginacion.innerHTML += "<div><a>...</a></div>";
        paginacion.innerHTML += "<div><a onclick=\"cambiarPagina('"+cantPaginas+"')\">&gt</a></div>";

        function getCategorias() {
          atras = true;
          variable = new XMLHttpRequest();
          paramsss = new URLSearchParams(window.location.search);
          if(!params.has("cat")) atras = false;
            variable.onload = function() {
              ...
              for (let index = 0; index < categorias.length; index++) {
                document.getElementById("lista-categorias").innerHTML += '<li onclick="CambiarCategoria(\''+categorias[index]["Nombre"]+'\')" class="mt-2 caja-productos-cat"><b class="link-dark rounded text-decoration-none productos-cat">'+categorias[index]["Nombre"]+'</b></li>';
                //console.log(categorias);
              }
              if(atras) {
                document.getElementById("lista-categorias").innerHTML += '<li class="linea"></li><li onclick="CambiarCategoria(\'Atras\')" class="mt-2 caja-productos-cat"><a class="link-dark rounded text-decoration-none productos-cat"><b>Atras</b></a></li>'
                atras = false;
              }
            }
            if(atras) document.getElementById("lista-categorias").innerHTML += '<li class="linea"></li><li onclick="CambiarCategoria(\'Atras\')" class="mt-2 caja-productos-cat"><a class="link-dark rounded text-decoration-none productos-cat"><b>Atras</b></a></li>';
            

            variable.open("GET", "../backend/catalogo-farmacia.php?cat="+(paramsss.has("cat") ? paramsss.get("cat"): -1)+"&subcat="+(paramsss.has("subcat") ? paramsss.get("subcat"): -1)+"&minicat="+(paramsss.has("minicat") ? paramsss.get("minicat"): -1)+"");
        ...
        function CambiarCategoria(categoria) {
          ...
          variable.open("POST", "../backend/catalogo-farmacia.php");
          variable.setRequestHeader("Content-type", "application/x-www-form-urlencoded");
          variable.send();
        }
        ...
        params = new URLSearchParams(window.location.search);
        if(params.has("orden")) {
          if(params.get("orden") == "menor") document.getElementById("ordenMenor").selected = "selected";
          else if(params.get("orden") == "mayor") document.getElementById("ordenMayor").selected = "selected";
          else document.getElementById("ordenReciente").selected = "selected";
        }
    </script>
