    ...
    <nav class="navbar navbar-expand-lg bg-light">
      <div class="d-flex container-fluid">
        <div class="d-flex container-fluid justify-content-center menor-menu">
         ...
         <form class="d-flex mx-auto formulario-buscador" action="catalogo.php" role="search">
...
<div class="offcanvas-lg offcanvas-start" tabindex="-1" id="offcanvasResponsive" aria-labelledby="offcanvasResponsiveLabel">
  ...
  <img src="./img/shopping-cart.svg" alt=""> Carrito</button></a>
                    ...
                    <?php
                      ...
                      $consultaNavbar = $bd->Consulta($query);
                      while($cat = $consultaNavbar->fetch_assoc()):;
                    ?>
                    <li class="">
                    <a class="nav-link dropdown-segundo-nav" href="catalogo.php?cat=<?php echo $cat["Nombre"]?>" role="button" aria-expanded="false">
                      <button class="btn btn-outline-success elementos-menu-responsive"><?php echo $cat["Nombre"]?></button>
                    </a>
 ...
 <div class="d-flex justify-content-center">
      ...
      <nav class="navbar navbar-expand-lg segundo-nav nav-principal" id="navbarNavAltMarkup">   
        <div class="container-fluid color-del-hover">
            <ul class="navbar-nav mx-auto texto-letras segundo-nav-ul-principal">
              <?php
                while($cat = $consultaNavbar->fetch_assoc()):;
              ?>
              <div class="nav-item nav-principal-bm dropdown-lol">
                <a href="catalogo.php?cat=<?php echo $cat["Nombre"]?>" class=""><button class="dropbtn"><?php echo $cat["Nombre"]?></button></a>
                <div class="dropdown-contenido scrollbar">
                  <?php
                    $querySub = "SELECT * from subcategoria where id_Cat = ".$cat["Id_Cat"];
                    $consultaNavbarSub = $bd->Consulta($querySub);
                    while($subcat = $consultaNavbarSub->fetch_assoc()):;

                  ?>
                    <a class="row-cols-md-auto" href="catalogo.php?cat=<?php echo $cat["Nombre"]?>&subcat=<?php echo $subcat["nombre"];?>"><?php echo $subcat["nombre"];?></a>
                  <?php endwhile; ?>
                </div> 
              </div>
